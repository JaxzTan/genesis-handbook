      ...
      <div className="flex flex-col">
        <div className="flex">
          ...
          <div className="cta-r">
            ...
            >
              <div className="font-mono text-[12px] tracking-[0.2em] uppercase text-white/55 mb-3.5 flex items-center gap-2.5">
              ...
              />
              <p className="text-[15px] leading-[1.65] text-white/80 mb-[18px] max-w-[44ch]">
              ...
              <a
                ...
                className="cta-discord-btn inline-flex items-center gap-2.5 px-[22px] py-3 bg-white text-g-accent text-[14px] font-semibold no-underline transition-all duration-200"
              >
            ...
            <div className="cta-role-wrap flex flex-col">
              {ROLES.map((r) => (
                <div key={r.name} className={`role-block fade-up ${r.delay}`}>
                  ...
                  <p className="text-[15px] leading-[1.65] text-white/80 max-w-[42ch] pl-4">
                    {r.blurb}
                  </p>
                </div>
              ))}
            ...
            <p className="fade-up d4 mt-9 font-serif italic text-[19px] text-white/65 leading-[1.55] max-w-[44ch] font-light">
